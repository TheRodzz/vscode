...
import { AgentHostSessionSyncEnabledConfigKey, AgentHostManagedPermissionsConfigKey, platformRootSchema, type AgentHostMcpServers, type IManagedPermissions } from '../../common/agentHostSchema.js';
...
type CopilotSessionLaunchConfig = ResumeSessionConfig & {
	...
	readonly managedSettings?: ICopilotManagedSettingsSdk;
};
